...
mod test_offline {
    ...
    fn test_create_tx_rejects_malformed_input_without_panicking() {
        ...
        // Over-long OP_RETURN payload.
        let too_long = "A".repeat(99_995);
        cli.wallet_cmd(&[
            "--wallet",
            WALLET_NAME,
            "create_tx",
        ...
        .assert()
        .code(1)
        .stderr(predicate::str::contains("OP_RETURN data is 99995 bytes"));
    }

    /// A `--fee_rate` that cannot be honoured is rejected up front instead of
